...
export function Menu() {
  ...
  return (
    <Container>
      ...
      {Mobile ? (
        <>
          <BotoesModal gridArea="filtrar" titulo="Filtrar">
            <ControleFiltros />
          </BotoesModal>
          <BotoesModal gridArea="ordenar" titulo="Ordenar">
            <ControladorOrdem estaNoModal={true} />
          </BotoesModal>
        </>
      ) : (
        <>
          <ControladorOrdem />
          <Aside>
            <ControleFiltros mostrarImputs={true} />
          </Aside>
        </>
      )}
      <ListaProdutos />
